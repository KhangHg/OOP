                    ...
                    if (choice_storeMenu == 1) {
                        do {
                            ...
                            if (choice_mediaDetailsMenu == 1)
                                ...
                                if (choice_mediaDetailsMenu != 0)
                                    System.out.println("Invalid choice");
                            }
                        } while (choice_mediaDetailsMenu != 0);
                    } else if (choice_storeMenu == 2)
                        ; // Add a media to cart
                    else if (choice_storeMenu == 3)
                        ; // Play a media
                    else if (choice_storeMenu == 4)
                        ; // See current cart (same choice_storeMenu 3)
                    else {
                        if (choice_storeMenu != 0)
                            System.out.println("Invalid choice");
                    }
                } while (choice_storeMenu != 0);
            } else if (choice_showMenu == 2)
                ; // Update store: allow add or remove media from store
            else if (choice_showMenu == 3)
                ; // See current cart: allow sort by title or cost
            else {
                if (choice_showMenu != 0)
                    System.out.println("Invalid choice");
            }
